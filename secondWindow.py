...
"")
        ...
        icon = QtGui.QIcon("./resource/icons/arrow-down-double.svg")
        ...
        icon =  QtGui.QIcon('./resource/icons/search.svg')
        ...
        icon =  QtGui.QIcon('./resource/icons/window-close.svg')
        ...
        self.dragLabel.setPixmap(QtGui.QPixmap("./resource/icons/drag-surface.svg"))
